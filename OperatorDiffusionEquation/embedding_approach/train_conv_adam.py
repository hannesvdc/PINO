...
model = ConvBranchEmbeddingNetwork( n_embedding_hidden_layers, n_hidden_layers, z, q, x_grid, l, T_max, tau_max, logk_max)
...
try:
    ...
    for epoch in range( 1, n_epochs+1 ):
        ...
        pt.save( model.state_dict(), store_directory + 'conv_model_adam.pth')
        pt.save( optimizer.state_dict(), store_directory + 'conv_optimizer_adam.pth')
...
np.save( store_directory + 'conv_train_data.npy', train_data)
np.save( store_directory + 'conv_validation_data.npy', validation_data)
